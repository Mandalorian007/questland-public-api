...
public class ItemLoader implements ApplicationRunner {
    ...
    private final String latestTokenUrl = "http://gs-bhs-wrk-02.api-ql.com/client/checkstaticdata/?lang=en&graphics_quality=hd_android";
    private final String itemUrl = "http://gs-bhs-wrk-01.api-ql.com/staticdata/key/en/android/%s/item_templates/";
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        log.info("Database load of items complete.");
    }

    private Item covertItemFromPrivate(PrivateItem privateItem) {
        return Item.builder()
                .id(privateItem.getId())
                .linkId(privateItem.getLinkId())
    ...
    private static int convertPotentialFromPrivate(PrivateStats stats) {
        return stats.getAttack()[1] + stats.getMagic()[1] + stats.getDefense()[1] + stats.getHealth()[1];
    }
